      ...
      <SidebarContent className="pt-4 flex flex-col h-full">
        <div className={`px-4 mb-6 ${collapsed ? "px-2" : ""}`}>
          <div className={`flex items-center gap-2 ${collapsed ? "justify-center" : ""}`}>
            <img src="/images/logo.png" alt="Inventory Manager" className="h-7 w-7 rounded-lg shrink-0 object-contain" />
            {!collapsed && (
              <span className="text-sm font-semibold tracking-tight text-foreground">Inventory Manager</span>
            )}
          </div>
        </div>
